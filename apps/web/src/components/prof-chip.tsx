...
export function AccChips({ professor, moduleName, className }: { professor: string | null; moduleName: string; className?: string }) {
  const acc = accentFor(professor);
