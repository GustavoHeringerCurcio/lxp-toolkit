...
export const en: Dict = {
  ...
  "project.intro": "Tell the AI the project's theme, actors and requirements so it fills the activity in the right context. You can let it detect them automatically.",
  "project.theme": "Theme",
