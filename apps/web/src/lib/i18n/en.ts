...
export const en: Dict = {
  ...
  "send.dialogDesc": "Review the content and format before sending.",
  "send.step.review": "Review",
  "send.step.format": "Format",
  ...
  "send.confirmHint": "By confirming, the answer is sent to the portal immediately.",
  "send.cancel": "Cancel",
