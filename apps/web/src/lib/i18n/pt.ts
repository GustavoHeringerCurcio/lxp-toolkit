...
export const pt = {
  ...
  "project.intro": "Informe o tema, os atores e os requisitos do projeto para a IA preencher a atividade no contexto certo. Você pode deixar a IA detectar automaticamente.",
  "project.theme": "Tema",
  ...
  "project.detected": "Detectado com {{model}}.",
  "project.detectedEmpty": "Nada detectado para esta atividade — preencha manualmente.",
  "project.save": "Salvar contexto",
  "project.saved": "Contexto salvo. Gere a resposta novamente para aplicá-lo.",
